...
final public class WelcomView: UIView {
...
@available(iOS 17.0, *)
#Preview("search") {
    let view = WelcomView(type: .search)
    return view
}

@available(iOS 17.0, *)
#Preview("Bookmark") {
    let view = WelcomView(type: .bookmark)
    return view
}
